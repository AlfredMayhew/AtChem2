...
contains
  ...
  subroutine mechanism_rates( t, y, p )
    ...
    real(kind=DP) :: n2, o2, m, rh, h2o, blheight, dec, jfac, dilute, roofOpen, asa, nox
    ...
    call proc( p, q, temp, n2, o2, m, rh, h2o, blheight, dec, jfac, dilute, roofOpen, asa, nox, j, ro2 )
